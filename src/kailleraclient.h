...
extern "C" {
  ...
  */
  void DLLEXP kailleraGetVersion(char *version);
  /*
     kailleraInit:
     Call this method when your program starts
  */
  void DLLEXP kailleraInit();
  /*
     kailleraShutdown:
     Call this method when your program ends
  */
  void DLLEXP kailleraShutdown();
  /*
     kailleraSetInfos:
  ...
  */
  void DLLEXP kailleraSetInfos(kailleraInfos *infos);
  /*
     kailleraSelectServerDialog:
     Use this method for launching the Kaillera server dialog
  */
  void DLLEXP kailleraSelectServerDialog(HWND parent);
